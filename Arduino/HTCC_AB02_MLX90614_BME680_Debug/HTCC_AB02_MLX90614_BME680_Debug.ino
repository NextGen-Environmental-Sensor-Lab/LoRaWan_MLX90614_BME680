...
#include "Adafruit_BME680.h"  //Constexpr error resolved http://community.heltec.cn/t/htcc-ab01-v2-and-ads1115-error/12112
...
Adafruit_BME680 bme(&Wire);  //Creation of object of type BME680 and calling the object bme
...
static void prepareTxFrame(uint8_t port) {
  ...
  */
  ...
  digitalWrite(VBAT_ADC_CTL, LOW);  // turn Vext on for bme680
